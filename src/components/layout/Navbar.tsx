    ...
    <header className="sticky top-0 z-50 bg-transparent border-b border-black/[0.04]">
      <div className="container mx-auto px-4 md:px-6 h-20 md:h-24 flex items-center justify-between max-w-7xl">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <a href={import.meta.env?.VITE_APP_URL || process.env.NEXT_PUBLIC_APP_URL || "https://app.wafrivet.com/login"} className="text-[15px] font-medium text-[#111811] hover:text-[#2D4D31] transition-colors">
            Login
          </a>
          <Link
            to="/#pricing"
