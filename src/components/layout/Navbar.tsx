    ...
    <header className="sticky top-0 z-50 bg-transparent border-b border-black/[0.04]">
      <div className="container mx-auto px-4 md:px-6 h-20 md:h-24 flex items-center justify-between max-w-7xl">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <a href="http://localhost:3001/login" className="text-[15px] font-medium text-[#111811] hover:text-[#2D4D31] transition-colors">
            Login
          </a>
          <Link
            to="/#pricing"
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[min(100vw-2rem,20rem)]">
              ...
              <nav className="flex flex-col gap-1 mt-6 font-quicksand">
                ...
                <a href="http://localhost:3001/login" className="mt-2 py-3 px-2 rounded-lg hover:bg-muted text-[15px] font-medium text-[#111811]">
                  Login
                </a>
