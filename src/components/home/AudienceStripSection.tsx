  ...
  return (
    <section id="audience" className="w-full py-16 md:py-24 bg-[#F7F9F7] border-y border-black/[0.06] scroll-mt-24">
      <div className="max-w-[1280px] mx-auto px-4 md:px-8">
        ...
        <h2 className="text-center font-sans font-medium text-[1.85rem] sm:text-[2.35rem] md:text-[2.75rem] text-[#111811] leading-[1.08] mb-4">
          Built for everyone in the livestock chain.
        </h2>
        <p className="text-center text-[#111811]/60 text-base md:text-lg max-w-2xl mx-auto mb-12 md:mb-14 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          {CARDS.map((card) => {
            ...
            return (
              ...
              >
                <div className="mb-5 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-[#2D4D31]/10 text-[#2D4D31]">
                  <Icon className="h-5 w-5" strokeWidth={2} aria-hidden />
                </div>
                <h3 className="text-lg font-semibold text-[#111811] mb-2 leading-snug">{card.title}</h3>
                <p className="text-sm font-medium text-[#2D4D31]/90 mb-3">{card.subtitle}</p>
                <p className="text-sm text-[#111811]/60 leading-relaxed mb-6 flex-1">{card.body}</p>
                <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#2D4D31] group-hover:gap-2.5 transition-all">
                  {card.cta}
