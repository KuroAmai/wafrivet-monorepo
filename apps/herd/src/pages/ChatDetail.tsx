...
export default function ChatDetail() {
  ...
  return (
    <div className="flex flex-col h-screen bg-white animate-in slide-in-from-right-8 duration-500 fixed inset-0 z-[60]">
      {/* Chat Header */}
      <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-md px-4 py-4 border-b border-gray-100 flex items-center justify-between">
        <div className="flex items-center gap-3">
           <Link to="/ai" className="p-2 hover:bg-gray-50 rounded-xl transition-all active:scale-90">
