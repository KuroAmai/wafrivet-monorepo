          ...
          <div className="flex items-center justify-between h-28">
              ...
              <button className="hidden sm:flex items-center gap-2 border-l border-gray-100 pl-4 group transition-colors">
                ...
                <div className="flex flex-col items-start">
                  ...
                  <div className="flex items-center gap-1">
                    <span className="text-[13px] text-gray-900 font-bold group-hover:text-[#2D4D31]">Lagos Island</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <button 
                ...
                className="group flex items-center gap-2 p-2 bg-transparent md:bg-[#2D4D31] hover:bg-gray-100 md:hover:bg-[#243f28] rounded-2xl transition-all md:pr-4"
              >
